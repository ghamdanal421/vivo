    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        ...
        <div class="panel-body"> 
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">Site Description meta</label>
            <div class="col-sm-9">
              <input type="text"  value="<?php echo $this->db->get_where('config' , array('title' =>'description_meta'))->row()->value;?>" name="description_meta" class="form-control" required  />
            </div>
          </div>    
          <div class="form-group row">
            <label class="col-sm-3 control-label">Site Logo</label>
            <div class="col-sm-9">
              <input type="url"  value="<?php echo $this->db->get_where('config' , array('title' =>'logo_site'))->row()->value;?>" name="logo_site" class="form-control" required  />
            </div>
          </div>         
