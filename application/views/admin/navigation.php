...
<aside class="app-sidebar">
  <ul class="app-menu">
    ...
    <li class="treeview <?php if($active_menu == 55 || $active_menu == 777 || $active_menu == 771 || $active_menu == 772 || $active_menu == 773) {echo "is-expanded"; } ?>"> <a href="#" class="app-menu__item" data-toggle="treeview"><i class="app-menu__icon fa fa-globe" aria-hidden="true"></i><span class="app-menu__label">WEBSITE</span> <i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
          
         

        <li><a class="treeview-item <?php if($active_menu==777) {echo "active"; } ?>" href="<?php echo base_url('admin/contact')?>"><i class="app-menu__icon fa fa-warning"></i><span class="app-menu__label">DISPLAY PROBLEMS</span></a></li>
        <li><a class="treeview-item <?php if($active_menu==773) {echo "active"; } ?>" href="<?php echo base_url('admin/request')?>"><i class="app-menu__icon fa fa-glass"></i><span class="app-menu__label">REQUESTS</span></a></li>

        <li><a class="treeview-item <?php if($active_menu==55) {echo "active"; } ?>" href="<?php echo base_url().'admin/aps_web'?>"><i class="app-menu__icon fa fa-flag"></i><span class="app-menu__label">APS WEB</span></a></li>
        </ul>
      </li>
