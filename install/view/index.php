...
<html lang="en">
    <head>
        ...
        <title>GHMV - Live TV & Movie Portal App Installation</title>
        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">                    
                    <h2>GHMV - Live TV & Movie Portal App Installation</h2>
                </div>
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Find in barmgely item download section" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
