...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `uesr_name` varchar(255)  NULL,
  `email` varchar(255)  NULL,
  `number_phone` varchar(255)  NULL,
  `user_id` int(10)  NULL,
  `message` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `user_agent` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `referer` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `user_ip` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `contact_at` datetime DEFAULT NULL,
  `approve_message` int(5) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  `uesr_name` varchar(255)  NULL,
  `email` varchar(255)  NULL,
  `name_anime` varchar(255)  NULL,
  `user_id` int(10)  NULL,
  `message` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `season` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `request_at` datetime DEFAULT NULL,
  `approve_request` int(5) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `notifications` (
  `notifications_id` int(20) NOT NULL AUTO_INCREMENT,
  `user_id` int(10)  NULL,
  `message_id` int(10)  NULL,
  `notifications` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `notifications_at` datetime DEFAULT NULL,
  `notifications_status` int(5) DEFAULT 0,
...
(192, 'description_meta', 'Description meta GHMV - Android Live TV & Movie Portal'),
(193, 'logo_site', 'assets/images/logo-wed.png'),
(194, 'system_name', 'GHMV - Android Live TV & Movie Portal'),
(195, 'site_name', 'My Movie Site'),
(196, 'business_address', ''),
(197, 'business_phone', ''),
(198, 'contact_email', 'contact@mydomain.com'),
(199, 'system_email', ''),
(200, 'system_short_name', 'GHMV'),
...
(254, 'latest_apk_url', 'http://GHMV.spagreen.net/demo/GHMV-v114.apk'),
...
DROP TABLE IF EXISTS `aps_web`;
CREATE TABLE IF NOT EXISTS `aps_web` (
  `aps_web_id` int(11) NOT NULL AUTO_INCREMENT,
  `aps_web_html` mediumtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `aps_web_address` int(11) DEFAULT 1,
  `status` int(11) DEFAULT 1,
  PRIMARY KEY (`aps_web_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

--
-- Dumping data for table `aps_web`
--

INSERT INTO `aps_web` (`aps_web_id`, `aps_web_html`, `aps_web_address`, `status`) VALUES
(1, 'APS WEB In Header	 ', 1, 1);

INSERT INTO `aps_web` (`aps_web_id`, `aps_web_html`, `aps_web_address`, `status`) VALUES
(2, 'APS WEB In Sidebar	 ', 2, 1);

INSERT INTO `aps_web` (`aps_web_id`, `aps_web_html`, `aps_web_address`, `status`) VALUES
(3, 'APS WEB In Content	 ', 3, 1);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `another_watch` longtext COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
INSERT INTO `user` (`user_id`, `name`, `another_watch`, `slug`, `username`, `email`, `password`, `gender`, `role`, `token`, `theme`, `theme_color`, `join_date`, `last_login`, `deactivate_reason`, `status`, `phone`, `dob`, `firebase_auth_uid`) VALUES
